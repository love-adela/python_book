...
from 13_3_binary_search_tree import BinarySearchTree, NodeBST
...
if __name__ == "__main__":
    ...
    print("이진 탐색트리입니까?", bst.is_bst())
    print("균형트리입니까?", bst.is_balanced())
    print("전위순회:", bst.preorder())
    print("전위순회2:", bst.preorder2())
    print("중위순회:", bst.inorder())
    print("너비우선탐색:", bst.BFT())
